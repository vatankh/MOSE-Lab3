...
//sa
    public void addAltPointToTable(AltPoint point){
    ...
    public List<AltPoint> getAltPoints(String session_id){
        List<AltPoint> pointsList = new ArrayList<>();
        try {
            if (connection == null)
                initConnection();
